<div id="Reviews" class="tab-pane fade">
    <div class="review">
        ...
        <div class="star">
            ...
            <div class="star-review">
                ...
                <div class="star-review-item">
                    <div class="name">5 {{ __('course_detail.stars') }}</div>
                    <div class="bar">
                        <div class="bar-item"
                ...
                <div class="star-review-item">
                    <div class="name">4 {{ __('course_detail.stars') }}</div>
                    <div class="bar">
                        <div class="bar-item"
                ...
                <div class="star-review-item">
                    <div class="name">3 {{ __('course_detail.stars') }}</div>
                    <div class="bar">
                        <div class="bar-item"
                ...
                <div class="star-review-item">
                    <div class="name">2 {{ __('course_detail.stars') }}</div>
                    <div class="bar">
                        <div class="bar-item"
                ...
                <div class="star-review-item">
                    <div class="name">1 {{ __('course_detail.stars') }}</div>
                    <div class="bar">
                        <div class="bar-item"
                        ...
                        <div class="function-menu">
                            ...
                            @if ($review->user->id == Auth::id())
                                ...
                                <div class="delete">
                                    ...
                                    <form action="{{ route('reviews.destroy', [$review->id]) }}" method="POST">
                                        ...
                                        <button type="submit" class="btn-comment">
                                            {{ __('course_detail.delete') }}</button>
                                    </form>
                                </div>
                                ...
                                <div class="edit">
                                    ...
                                    <button class="btn-comment btn-edit">{{ __('course_detail.edit') }}</button>
        ...
        <form class="form-review" action="{{ route('reviews.store') }}" method="POST">
            @csrf
            <label for="">{{ __('course_detail.message') }}</label>
            <br/>
